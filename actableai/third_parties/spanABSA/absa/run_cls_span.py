...
from actableai.third_parties.spanABSA.bert.sentiment_modeling import BertForSpanAspectClassification

from actableai.third_parties.spanABSA.squad.squad_evaluate import exact_match_score
from actableai.third_parties.spanABSA.absa.utils import read_absa_data, convert_absa_data, convert_examples_to_features, \
...
def eval_absa(all_examples, all_features, all_results, do_lower_case, verbose_logging, logger):
    ...
    for (feature_index, feature) in enumerate(all_features):
        ...
        print("========== result.cls_pred ==========")
        print(result.cls_pred)
        print("========== result.cls_pred end ==========")
