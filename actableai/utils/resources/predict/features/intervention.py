...
class InterventionFeaturesExtractor(MethodFeaturesExtractor):
    """
    ...
    def _extract_all_features(arguments: dict) -> dict:
        """
        Extract all features for the Correlation task

        Parameters
        ----------
        arguments:
            The arguments used to call the Correlation task and to extract the features from
