...
from actableai.utils.resources.predict.features.association_rules import (
    AssociationRulesFeaturesExtractor,
)
...
_features_extractors = {
    ...
    TaskType.ASSOCIATION_RULES: AssociationRulesFeaturesExtractor,
}
