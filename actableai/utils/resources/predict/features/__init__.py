...
from actableai.utils.resources.predict.features.forecast import ForecastFeaturesExtractor
from actableai.utils.resources.predict.features.method import MethodFeaturesExtractor
from actableai.utils.resources.predict.features.regression import RegressionFeaturesExtractor, \
    RegressionTrainFeaturesExtractor
from actableai.utils.resources.predict.features.bayesian_regression import BayesianRegressionFeaturesExtractor
from actableai.utils.resources.predict.features.classification import ClassificationFeaturesExtractor, \
    ClassificationTrainFeaturesExtractor
from actableai.utils.resources.predict.features.clustering import ClusteringFeaturesExtractor, \
    DECAnchorClusteringFeaturesExtractor
from actableai.utils.resources.predict.features.correlation import CorrelationFeaturesExtractor
from actableai.utils.resources.predict.features.data_imputation import DataImputationFeaturesExtractor
from actableai.utils.resources.predict.features.sentiment_analysis import SentimentAnalysisFeaturesExtractor
...
def get_features_extractor(resource_predicted: ResourcePredictorType,
                           task: TaskType,
                           function: Callable) -> MethodFeaturesExtractor:
    """
    ...
    if features_extractor is None:
        raise NotImplementedError(f"The features extractor for this task ({task}) is not implemented")
    return features_extractor(resource_predicted=resource_predicted, function=function)


def extract_features(resource_predicted: ResourcePredictorType,
                     task: TaskType,
                     function: Callable,
                     *args, **kwargs) -> dict:
    """
