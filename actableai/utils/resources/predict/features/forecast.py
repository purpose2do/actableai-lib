...
class ForecastFeaturesExtractor(MethodFeaturesExtractor):
    """
    ...
    def _extract_all_features(arguments: dict) -> dict:
        """
        Extract all features for the Forecast task

        Parameters
        ----------
        arguments:
            The arguments used to call the Forecast task and to extract the features from
