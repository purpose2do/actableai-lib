...
class RFParams(BaseParams):
    ...
    def _get_hyperparameters(cls, *, problem_type: str, **kwargs) -> Parameters:
        ...
        # NOTE: Parameters virtually identical to those for Extra Trees (XT).
        ...
        parameters = [
            ...
            OptionsParameter[str](
                ...
                # TODO: Check if 'None' can be used as a string. Also
                # ensure that the description is also updated. 'None' = number
                # of features for regression, = sqrt for classification
            ),
        ]
