...
def test_inflate_categorical_polynomial_mixed():
    ...
    assert list(df_polynomial.columns) == ['x', 'y_a', 'y_b', 'y_c', 'x^2', 'x y_a', 'x y_b', 'x y_c', 'x^3', 'x^2 y_a', 'x^2 y_b', 'x^2 y_c', 'x^4', 'x^3 y_a', 'x^3 y_b', 'x^3 y_c']
...
def test_inflate_categorical_polynomial_multi_cat():
    ...
    assert list(df_polynomial.columns) == [
        'x', 'y_a', 'y_b', 'y_c', 'z_a', 'z_b', 'z_c', 'x^2', 'x y_a', 'x y_b', 'x y_c', 'x z_a', 'x z_b', 'x z_c', 'y_a z_a', 'y_a z_b', 'y_a z_c', 'y_b z_a', 'y_b z_b', 'y_b z_c', 'y_c z_a', 'y_c z_b',
        'y_c z_c', 'x^3', 'x^2 y_a', 'x^2 y_b', 'x^2 y_c', 'x^2 z_a', 'x^2 z_b', 'x^2 z_c', 'x y_a z_a', 'x y_a z_b', 'x y_a z_c', 'x y_b z_a', 'x y_b z_b', 'x y_b z_c', 'x y_c z_a', 'x y_c z_b', 'x y_c z_c',
        'x^4', 'x^3 y_a', 'x^3 y_b', 'x^3 y_c', 'x^3 z_a', 'x^3 z_b', 'x^3 z_c', 'x^2 y_a z_a', 'x^2 y_a z_b', 'x^2 y_a z_c', 'x^2 y_b z_a', 'x^2 y_b z_b', 'x^2 y_b z_c', 'x^2 y_c z_a', 'x^2 y_c z_b', 'x^2 y_c z_c']
...
def test_inflate_categorical_polynomial_reasonable():
    ...
    assert list(df_polynomial.columns) == [
        'x', 'y_a', 'y_b', 'y_c', 'z_a', 'z_b', 'z_c', 't_d', 't_e', 't_f', 'x^2', 'x y_a', 'x y_b', 'x y_c', 'x z_a', 'x z_b', 'x z_c', 'x t_d', 'x t_e', 'x t_f', 'y_a z_a', 'y_a z_b',
        'y_a z_c', 'y_a t_d', 'y_a t_e', 'y_a t_f', 'y_b z_a', 'y_b z_b', 'y_b z_c', 'y_b t_d', 'y_b t_e', 'y_b t_f', 'y_c z_a', 'y_c z_b', 'y_c z_c', 'y_c t_d', 'y_c t_e', 'y_c t_f', 'z_a t_d',
        'z_a t_e', 'z_a t_f', 'z_b t_d', 'z_b t_e', 'z_b t_f', 'z_c t_d', 'z_c t_e', 'z_c t_f']

    assert orig_dummy_list == ['x', 'y_a', 'y_b', 'y_c', 'z_a', 'z_b', 'z_c', 't_d', 't_e', 't_f']
