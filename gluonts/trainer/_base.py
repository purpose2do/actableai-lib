...
class Trainer:
    ...
    post_epoch_callback
        ...
        epoch number and epoch loss `post_epoch_callback(net, epoch_no, enpoch_loss)` after each epoch.
    """
        ...
        with tempfile.TemporaryDirectory(
            ...
            with HybridContext(
                ...
                def loop(
                    ...
                    with tqdm(batch_iter) as it:
                        for batch_no, data_entry in enumerate(it, start=1):
                            ...
                            logger.info("epoch no: %d, batch no: %d, epoch_loss: %.3f", epoch_no, batch_no, lv)
                ...
                for epoch_no in range(self.epochs):
                    ...
                    logger.info(f"Epoch: {epoch_no}, Loss: {epoch_loss}")
